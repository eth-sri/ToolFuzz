...
mkdir -p $root_dir/01_PreProduction/01_Concepts/Logo_Designs
mkdir -p $root_dir/01_PreProduction/01_Concepts/Poster_Designs
...
mkdir -p $root_dir/02_Production/07_Rendering/Comps
mkdir -p $root_dir/02_Production/07_Rendering/Render_Layers
...
touch $root_dir/01_PreProduction/01_Concepts/Logo_Designs/logo_sketch_v1.jpg
touch $root_dir/01_PreProduction/01_Concepts/Logo_Designs/logo_sketch_v2.jpg
touch $root_dir/01_PreProduction/01_Concepts/Poster_Designs/poster_sketch_v1.jpg
...
touch $root_dir/02_Production/07_Rendering/Comps/scene1_comp_v1.psd
touch $root_dir/02_Production/07_Rendering/Render_Layers/scene1_layer1.exr
