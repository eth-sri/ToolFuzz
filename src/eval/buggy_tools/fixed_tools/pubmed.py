...
ORIGINAL_DESCRIPTION = ("A wrapper around PubMed. "
...
class PubmedQueryRunFixed(BaseTool):
    """Tool that searches the PubMed API."""

    name: str = "pub_med"
    description: str = (
        "A wrapper around PubMed. "
        "Useful for when you need to answer questions ONLY about medicine, health, "
        "and biomedical topics from biomedical literature, MEDLINE, life science journals, and online books. "
        "This tool is not sufficient to answer general questions! "
        "Input should be a search query."
        "The query has special syntax for different fields in the paper:\n"
        "The list of available search fields is: All Fields, Author, Date - Create/Publication, EC/RN Number, Editor, Title/Abstract, Volume"
