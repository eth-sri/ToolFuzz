...
Tool Arguments: [{'file_manager_id': {'description': 'ID of the file manager where the file will be opened, if not provided the recent file manager will be used to execute the action. Please provide a value of type string.', 'type': 'string'}}, {'file_path': {'description': 'file path to open in the editor. This is a relative path to the current directory. Please provide a value of type string. This parameter is required.', 'type': 'string'}}, {'line_number': {'description': 'If file-number is given, file will be opened from that line number. Please provide a value of type integer.', 'type': 'integer'}}]
...
Tool Arguments: [{'query': {'description': 'Full-text query to filter the posts. Please provide a value of type string. This parameter is required.', 'type': 'string'}}, {'tags': {'description': 'Filter on a specific tag. Available tags: story, comment, poll, pollopt, show_hn, ask_hn, front_page, author_<USERNAME>, story_<ID>.', 'type': 'array'}}, {'page': {'description': 'Page number for pagination. Please provide a value of type integer.', 'type': 'integer'}}]
...
Tool Arguments: [{'location': {'description': 'The location for which weather information is requested (e.g., 'London,GB', 'London').You may specify the country code or not. If you get city not found error, try without country code. Please provide a value of type string. This parameter is required.', 'type': 'string'}}]
Tool Description: Tool For Querying The Open Weather Map Api.'''


class TestLangchainComposioToolWrapper(unittest.TestCase):
